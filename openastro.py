...
for i in range(len(LANGUAGES)):
	try:
		...
		print("IOError! Invalid languages specified ({}) in {}".format(LANGUAGES[i],TDomain))
...
class mainWindow:
	...
	def specialSecondaryProgression(self, widget):
		...
		hbox.pack_start(entry['Y'],True,True,True)
		...
		hbox.pack_start(entry['M'],True,True,True)
		...
		hbox.pack_start(entry['D'],True,True,True)
		...
		hbox.pack_start(entry['h'],True,True,True)
